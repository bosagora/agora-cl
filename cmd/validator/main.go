...
func main() {
	app := cli.App{}
	app.Name = "validator"
	app.Usage = `launches an Agora validator client that interacts with the Agora Consensus Layer, starts proposer and attester services, p2p connections, and more`
